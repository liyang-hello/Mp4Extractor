...
public final class Mesh {
    ...
    /* package */ void glInit(int textureId) {
        ...
        program = GLUtil.createProgram(TextUtils.join("\n", VERTEX_SHADER_CODE),TextUtils.join("\n", FRAGMENT_SHADER_CODE) );
     ...
     */
    public void draw(float[] mvpMatrix, int eyeType) {
        // Configure shader.
        ...
        int textureOffset =
                (eyeType == 0) ? POSITION_COORDS_PER_VERTEX + 2 : POSITION_COORDS_PER_VERTEX;
